...
public class testexampage extends AppCompatActivity {
    ...
    String backString="Back",nextString="next",Question="Question ",finish="Finish",test="test",cheatString;
    String[] answers;
    int[] checked;
...
//******************************************************************************************
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(testexampage.this);
//********************************************************
        //takePicture();
        ...
        question = (ArrayList<Question>)  mIntent.getSerializableExtra("testexam");
        ...
        rb1.setText(question.get(0).getChoice1());
        rb2.setText(question.get(0).getChoice2());
        rb3.setText(question.get(0).getChoice3());
        rb4.setText(question.get(0).getChoice4());
    ...
    public void back(View view) {
        ...
        rb1.setText(question.get(iterator).getChoice1());
        rb2.setText(question.get(iterator).getChoice2());
        rb3.setText(question.get(iterator).getChoice3());
        rb4.setText(question.get(iterator).getChoice4());
    ...
    public void Checktest(ArrayList<Question> question,String[] answers) {


        for (int i = 0; i < number; i++) {
            Log.d("comparing ", " answer : " + answers[i] + " real answer: " + question.get(i).getAnswer());


            if (!(answers[i].equals("null"))){
                if (answers[i].equals(question.get(i).getAnswer()))
                    trueAns++;
                if (!answers[i].equals(question.get(i).getAnswer()))
                    falseAns++;
            }
    ...
    public void StartTimer(){
        ...
        countDownTimer=new CountDownTimer(timerDuration,1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                //BÖYLE DEĞİL  if(millisUntilFinished%5==0)

                if(secLeft%5==0)   //BÖYLE
                  takePicture();
            }
...
//************************************************************************************
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode == REQUEST_CAMERA_PERMISSION)
        {
            ...
            {
                Toast.makeText(this, "Cant Run Cheat Control", Toast.LENGTH_SHORT).show();
                //finish();
            }
        }
    }
...
if(iterator==0){
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                startActivity(new Intent(testexampage.this,starterPage.class));
                finish();
            }
        });
    builder.show();
