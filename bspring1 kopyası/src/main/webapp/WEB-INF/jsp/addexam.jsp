<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="java.util.List,com.bitirme.service.BitirmeService" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="java.util.Iterator" %>
<%@ page import="com.bitirme.model.Exam" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="container">
  ...
  <div class="row">
    <div class="col-25">
      <label for="fname">Numara</label>
    </div>
    <div class="col-75">
      <input type="text" id="id" name="examid" placeholder="Sınav numarası.." path= "id">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="lname">Sınav adı</label>
    </div>
    <div class="col-75">
  ...
  <div class="row">
    <div class="col-25">
      <label for="country">İş tanımı</label>
    </div>
    <div class="col-75">
  ...
  <div class="row">
    <div class="col-25">
      <label for="country">Sınav başlama tarihi</label>
    </div>
    <div class="col-75">
  ...
  <div class="row">
    <div class="col-25">
      <label for="country">Sınav bitiş tarihi</label>
    </div>
    <div class="col-75">
  ...
  <div class="row">
    <div class="col-25">
      <label for="country">Sınav süresi</label>
    </div>
    <div class="col-75">
  ...
  <div class=".btn">
    ...
    <input type="submit" value="Ekle">
     -->
   	...
   	<button onclick="bitirmeService.createExam(exam)">Sınav ara</button>
